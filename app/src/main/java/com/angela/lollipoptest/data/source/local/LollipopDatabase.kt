...
/**
 * A database that stores Drama information.
...
abstract class LollipopDatabase : RoomDatabase() {
    ...
    /**
     * Define a companion object, this allows us to add functions on the LollipopDatabase class.
     *
     * For example, clients can call `LollipopDatabase.getInstance(context)` to instantiate
     * a new LollipopDatabase.
     */
    companion object {
        /**
